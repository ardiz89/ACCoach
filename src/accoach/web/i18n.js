...
(function () {
  ...
  var CAT = {
    ...
    "tour.a2.x": { en: `The same laps seen other ways: traces side by side in Compare, the racing line on the Map, split times in Sectors, grip and slip in Dynamics, and where you're heading in Trends.`,
                   it: `Gli stessi giri visti in altri modi: le tracce affiancate in Confronto, la traiettoria sulla Mappa, gli split nei Settori, aderenza e slittamenti in Dinamica, e dove stai andando in Andamento.` },
