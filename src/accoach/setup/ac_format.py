...
AC_PARAMS: tuple[AcSpec, ...] = (
    _spec("tyrePressure", "Tyres", "Pressure", _wheel("PRESSURE"), "psi"),
    _spec("camber", "Alignment", "Camber", _wheel("CAMBER")),
    _spec("toe", "Alignment", "Toe", _wheel("TOE_OUT")),
    _spec("frontWing", "Aero", "Front wing", ("WING_1",)),
    _spec("rearWing", "Aero", "Rear wing", ("WING_2",)),
    _spec("aRBFront", "Mechanical", "Front ARB", ("ARB_FRONT",)),
    _spec("aRBRear", "Mechanical", "Rear ARB", ("ARB_REAR",)),
    _spec("wheelRate", "Mechanical", "Springs", _wheel("SPRING_RATE")),
    _spec("bumpSlow", "Dampers", "Bump", _wheel("DAMP_BUMP")),
    _spec("reboundSlow", "Dampers", "Rebound", _wheel("DAMP_REBOUND")),
    _spec("rideHeight", "Ride height", "Ride height (rod length)", _wheel("ROD_LENGTH"), "mm"),
    _spec("diffPower", "Drivetrain", "Diff power", ("DIFF_POWER",)),
    _spec("diffCoast", "Drivetrain", "Diff coast", ("DIFF_COAST",)),
    _spec("preload", "Drivetrain", "Diff preload", ("DIFF_PRELOAD",)),
    _spec("finalRatio", "Drivetrain", "Final drive", ("FINAL_RATIO",)),
    _spec("brakeBias", "Brakes", "Brake bias", ("FRONT_BIAS",), "%"),
    _spec("brakePower", "Brakes", "Brake power", ("BRAKE_POWER_MULT",), "%"),
    _spec("tC1", "Electronics", "Traction control", ("TRACTION_CONTROL",), "liv."),
    _spec("abs", "Electronics", "ABS", ("ABS",), "liv."),
    _spec("fuel", "Strategy", "Fuel", ("FUEL",), "L"),
)
