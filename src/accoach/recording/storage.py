...
def find_reference_lap(
    ...
    ``road_temp``, ``grip`` and ``compound`` are today's conditions: pass them
    and a lap driven in comparable ones is preferred over a faster one driven in
    different ones (see :meth:`LapCatalog.best_reference_path` for how they are
