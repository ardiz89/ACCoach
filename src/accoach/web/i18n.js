...
(function () {
  ...
  var CAT = {
    ...
    "map.leg.slower":  { en: `slower <small>(thicker line = more time lost)</small>`,
                         it: `più lento <small>(linea più spessa = più tempo perso)</small>` },
    "map.leg.faster":  { en: `faster <small>(thinner line = on par)</small>`,
                         it: `più veloce <small>(linea più sottile = alla pari)</small>` },
